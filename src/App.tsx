...
export default function App() {
  ...
  return (
    <>
      ...
      {/* Main App */}
      <div className="min-h-screen h-screen w-screen bg-gradient-to-br from-[#A2C2E1] via-[#E2BBE9] to-[#F9D1D1] font-sans flex flex-col p-2 sm:p-4 md:p-6 relative overflow-y-auto overflow-x-hidden select-none">
        ...
        <div className="flex-1 flex relative z-10 w-full h-full min-h-0">
          {currentUser ? (
            ...
            <div className="m-auto w-full max-w-[420px] py-4">
