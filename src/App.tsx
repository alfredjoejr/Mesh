...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#A2C2E1] via-[#E2BBE9] to-[#F9D1D1] font-sans flex flex-col p-2 sm:p-4 md:p-8 relative overflow-hidden select-none">
      ...
      <div className="flex-1 flex relative z-10 w-full h-full max-w-[1200px] mx-auto min-h-0">
        {currentUser ? (
